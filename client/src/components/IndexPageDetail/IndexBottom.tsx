...
const IndexBottom: React.FC = () => {
  const titles = ["Set Preferences", "Mark Availability", "Mock Interview"];
  const introductions = [
    "After logging in, you can set up interview preferences like programming languages, difficullty of questions etc.",
    "Mark your availabilities on dashbord page, send interview invitations to matched peers or accept invitations from others.",
    "Click the link on top of your dashbord to access the confirmed interview. Interact with peers by code editor and two live video screens.",
  ];
